...
fun WorkExtraTypeAddRoute(
    ...
    if (curEmployer != null) {
        ...
        WorkExtraTypeScreen(
            ...
            onUpdate = { newExtraType: ms.mattschlenkrich.paycalculator.data.WorkExtraTypes ->
...
fun WorkExtraTypeUpdateRoute(
    ...
    if (curEmployer != null && curExtraType != null) {
        ...
        WorkExtraTypeScreen(
            ...
            existingExtraTypes = extraTypeList,
            onUpdate = { updatedExtraType: ms.mattschlenkrich.paycalculator.data.WorkExtraTypes ->
                workExtraViewModel.updateWorkExtraType(updatedExtraType)
                mainViewModel.setWorkExtraType(updatedExtraType)
                navController.popBackStack()
            },
            onDelete = { extraTypeToDelete: ms.mattschlenkrich.paycalculator.data.WorkExtraTypes ->
                workExtraViewModel.updateWorkExtraType(
                    ms.mattschlenkrich.paycalculator.data.WorkExtraTypes(
