...
import ms.mattschlenkrich.paycalculator.workorder.IWorkOrderUpdateFragment
...
class WorkOrderHistoryAdapter(
    ...
    private val differCallBack = object : DiffUtil.ItemCallback<WorkOrderHistoryWithDates>() {
        override fun areItemsTheSame(
            oldItem: WorkOrderHistoryWithDates, newItem: WorkOrderHistoryWithDates
        ): Boolean {
        ...
        override fun areContentsTheSame(
            ...
            return oldItem.history.woHistoryId == newItem.history.woHistoryId && oldItem.workDate.workDateId == newItem.workDate.workDateId && oldItem.workOrder.workOrderId == newItem.workOrder.workOrderId
        }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemBinding.apply {
            ...
            if (history.history.woHistoryNote.isNullOrBlank()) {
                ...
                tvSummary.text = history.history.woHistoryNote
    ...
    private fun chooseOptions(history: WorkOrderHistoryWithDates) {
        AlertDialog.Builder(mView.context).setTitle(
            mView.context.getString(R.string.choose_option_for) + " ${mView.context.getString(R.string.work_performed_on)}" + " ${
                df.getDisplayDate(
