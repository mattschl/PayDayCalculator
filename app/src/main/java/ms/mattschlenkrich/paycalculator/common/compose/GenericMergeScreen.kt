...
@Composable
fun <T, C> GenericMergeScreen(
    itemList: List<T>,
    parentName: String,
    onParentNameChange: (String) -> Unit,
    onParentSelected: (T) -> Unit,
    childList: List<C>,
    onRemoveChild: (C) -> Unit,
    childName: String,
    onChildNameChange: (String) -> Unit,
    onChildSelected: (T) -> Unit,
    onMergeAction: (Int) -> Unit,
    onDoneClick: () -> Unit,
    onListItemSelected: (T) -> Unit,
    itemToName: (T) -> String,
    childToName: (C) -> String,
    childIsDeleted: (C) -> Boolean,
    masterTitleRes: Int,
    parentLabelRes: Int,
    childLabelRes: Int,
    ...
    var showMergeOptionsDialog by remember { mutableStateOf(false) }
        ...
        LazyVerticalStaggeredGrid(
            ...
            item(span = StaggeredGridItemSpan.FullLine) {
                Column(
                    ...
                    Text(
                        text = stringResource(masterTitleRes),
                    ...
                    AutoCompleteTextField(
                        ...
                        label = stringResource(parentLabelRes),
                        ...
                        Column(
                            ...
                            childList.forEach { child ->
                                Row(
                                    ...
                                    val isDeleted = childIsDeleted(child)
            ...
            item(span = StaggeredGridItemSpan.FullLine) {
                Column(
                    ...
                    AutoCompleteTextField(
                        ...
                        label = stringResource(childLabelRes),
                        suggestions = itemList,
                        itemToString = itemToName,
