...
import ms.mattschlenkrich.paycalculator.workdate.IWorkDateAddFragment
...
//                changed to automatically saved
//                confirmSaveWorkDate(chkExtra.isChecked, extra)
                saveWorkDate(chkExtra.isChecked, extra)
            }
...
//    }
    ...
    private fun saveWorkDate(
        ...
        workDateAddFragment.validateWorkDateToSave(FRAG_WORK_DATE_UPDATE, true)
    }
}