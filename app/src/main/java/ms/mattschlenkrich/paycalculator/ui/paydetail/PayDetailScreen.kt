...
import ms.mattschlenkrich.paycalculator.ui.paydetail.components.SelectionCard
import ms.mattschlenkrich.paycalculator.ui.paydetail.components.SummaryCard
...
fun PayDetailScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.pay_details)) },
                navigationIcon = {
